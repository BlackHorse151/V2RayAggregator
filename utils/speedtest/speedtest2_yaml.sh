...
sudo nohup ./lite-linux-amd64 --config ./lite_config.json --test https://raw.githubusercontent.com/BlackHorse151/V2RayAggregator/master/sub/sub_merge_yaml.yml > speedtest.log 2>&1 &
